...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements IOrderInfoService {
     ...
     */
    @Override
    public List<LinkedHashMap<String, Object>> queryOrderWorkList() {
        return baseMapper.queryOrderWorkList();
    }
    ...
    public boolean audit(String orderCode, String status) {
        ...
        StaffInfo staffInfo = staffInfoService.getById(order.getStaffId());
        if (staffInfo != null) {
            staffInfo.setPrice(NumberUtil.add(staffInfo.getPrice(), order.getDistributionPrice()));

    ...
    <a-form :form="form" layout="vertical" v-if="nextFlag == 1">
      <a-row :gutter="10">
        <div style="font-size: 13px;font-family: SimHei" v-if="orderInfo !== null">
          ...
          <br/>
          <a-row style="padding-left: 24px;padding-right: 24px;">
            <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">选择 配送/堂食</span></a-col>
            <a-col :span="24">
        ...
        <div style="font-size: 13px;font-family: SimHei" v-if="orderItemInfo.length !== 0">
          <a-row style="padding-left: 24px;padding-right: 24px;">
            <a-col style="margin-bottom: 15px"><span style="font-size: 15px;font-weight: 650;color: #000c17">购买餐品</span></a-col>

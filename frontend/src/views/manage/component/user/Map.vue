              ...
              <div style="font-size: 12px;font-family: SimHei;color: #404040;margin-top: 25px">
                <div>
                  ...
                  <div style="margin-top: 150px;text-align: center"  v-if="checkList.length === 0">
                    ...
                    <h1 style="margin-top: 20px">请选择餐品</h1>
                  </div>
                </div>
              </div>
            </div>
...
<!--                    <a-alert :message="'购买餐品热量【'+totalHeat+'】 超过600，请合理规划' " banner v-if="totalHeat > 600"/>-->
                    <a-row style="padding-left: 20px;padding-right: 20px;margin-top: 30px">
                      <a-col style="margin-bottom: 15px"><span style="font-size: 13px;font-weight: 650;color: #000c17">选择 配送/堂食</span></a-col>
                      <a-col :span="24">
                    ...
                    <div style="padding-left: 20px;margin-top: 25px;text-align: right;padding-right: 30px"><span>餐品合计</span>
                      <span style="color: red">{{ totalPrice }} 元</span>
                    </div>

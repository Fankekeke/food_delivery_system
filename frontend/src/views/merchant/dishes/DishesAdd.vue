  ...
  <a-modal v-model="show" title="新增餐品" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        ...
        <a-col :span="12">
          <a-form-item label='餐品余量' v-bind="formItemLayout">
            <a-input-number style="width: 100%" v-decorator="[
            'laveNum',
            { rules: [{ required: true, message: '请输入餐品余量!' }] }
            ]" :min="1" :step="1"/>
          </a-form-item>
        </a-col>
        <a-col :span="12">
          <a-form-item label='餐品类型' v-bind="formItemLayout">
            ...
            'typeId',
            { rules: [{ required: true, message: '请输入餐品类型!' }] }
            ]">
        ...
        <a-col :span="24">
          <a-form-item label='餐品描述' v-bind="formItemLayout">
            <a-textarea :rows="6" v-decorator="[
            'content',
             { rules: [{ required: true, message: '请输入餐品描述!' }] }
            ]"/>
          </a-form-item>
        </a-col>
        <a-col :span="24">

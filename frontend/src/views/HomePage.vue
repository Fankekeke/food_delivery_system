        ...
        <a-col :span="12">
          <div>
            <a-row class="more-info" v-if="user.roleId == 74">
              ...
              <a-col :span="4">
                <head-info title="配送员数量" :content="titleAdminData.staffNum" :center="false" :bordered="false"/>
              </a-col>
              <a-col :span="4">
            ...
            <a-row class="more-info" v-if="user.roleId == 75">
              ...
              <a-col :span="4">
                <head-info title="配送员数量" :content="titleData.staffNum" :center="false" :bordered="false"/>
              </a-col>
              <a-col :span="4">
